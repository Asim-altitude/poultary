...
class AssetUnitFBModel {
  /// Firestore document id (same as unit.sync_id ideally)
  String? masterId;

  /// Full Asset Unit object
  ToolAssetUnit unit;
  ...
  // ---------------- FROM FIREBASE JSON ----------------
  factory AssetUnitFBModel.fromJson(
    ...
    return AssetUnitFBModel(
      masterId: documentId ?? json['master_id'],

      unit: ToolAssetUnit.fromFirebaseJson(
