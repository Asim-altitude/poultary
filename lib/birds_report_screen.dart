                 ...
                 Align(
                     ...
                     child: Row(
                       children: [
                         ...
                         Text('Birds Summary',style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.deepPurple),),
                       ],
                     )),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    list.elementAt(index).item_type == 'Reduction'? Align(
                                        alignment: Alignment.topLeft,
                                        child: Container(margin: EdgeInsets.all(5), child: Text(list.elementAt(index).reason.toString(), style: TextStyle( fontWeight: FontWeight.normal, fontSize: 14, color: Colors.black),))) : Align(
                                        alignment: Alignment.topLeft,
                                        child: Container(margin: EdgeInsets.all(5), child: Text(list.elementAt(index).acqusition_type.toString(), style: TextStyle( fontWeight: FontWeight.normal, fontSize: 14, color: Colors.black),))),
