...
Future<void> main() async {
  ...
  runApp(EasyLocalization(
          supportedLocales: [Locale('en'), Locale('ar'),Locale('de'),Locale('ru'),Locale('fa'),Locale('it'),Locale('ja'),Locale('ko'),Locale('pt'),Locale('tr'),Locale('fr'),Locale('id'),Locale('hi'),Locale('es'),Locale('zh'),Locale('uk'),Locale('ur'),Locale('pl'),Locale('bn'),Locale('te'),Locale('ta'),Locale('el')],
